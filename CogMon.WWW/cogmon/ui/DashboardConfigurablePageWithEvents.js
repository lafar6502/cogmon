Ext.define('CogMon.ui.DashboardConfigurablePageWithEvents', {
    extend: 'Ext.panel.Panel',
	requires: [],
	uses: [
		'CogMon.ui.RrdGraphPortlet', 'Ext.app.PortalPanel', 'CogMon.ui.AddPortletPanel', 
		'CogMon.ui.DatePickField', 'CogMon.ui.DetailedGraphViewPanel', 'CogMon.ui.AddDataSeriesPortletPanel',
		'CogMon.ui.EventCategorySelectGridPanel'
	],
    alias: 'widget.dashboardconfigurablepagewevents',
    startTime: 'e-1d',
    endTime: 'now',
	pinnedByMe: false,
	editable: false,
	...
	initComponent: function() {
        ...
        if (!Ext.isEmpty(this.pageConfig)) {
            ...
            me.items[0] = Ext.create('Ext.app.PortalPanel', pcfg);
        }
